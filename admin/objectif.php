...
if (isset($objectifs) && count($objectifs) > 0) {
    ...
    echo '<h1>Mes objectifs</h1>';
    echo '<table class="table table-striped tablec" border="1">';
    echo '<tr><th class="table-cell">Nom de l\'Objectif</th><th class="table-cell">Note</th></tr>';
    
    foreach ($objectifs as $objectif) {
        echo '<tr>';
        echo '<td class="table-cell">' . htmlspecialchars($objectif['Nomobjectif']) . '</td>';
        echo '<td class="table-cell">' . htmlspecialchars($objectif['Note']) . '</td>';
        echo '</tr>';
    }
